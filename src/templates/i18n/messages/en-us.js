export default {
  ...
  terms: {
    ...
    para1: "These terms and conditions outline the rules and regulations for the use of {app.$defaultName}'s Website, located at https://{app.$defaultUrl}.",
